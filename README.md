...
| <a name="input_force_project_scope"></a> [force\_project\_scope](#input\_force\_project\_scope) | When true, forces project-scoped IAM bindings even if organizations are discoverable. This creates explicit project-level bindings instead of organization-level bindings. | `bool` | `false` | no |
